...
<head>
    ...
    <title>Assignnnnnn Evaluator</title>
...
<body>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input check-box" type="checkbox" value="" id="flexCheckDefault" onclick="handleCheckboxSelection(event)">
                                        </div>
                                    </td>
                                    <td>
    ...
    <script>
        ...
        const selectedCheckboxes = document.querySelectorAll('.check-box:checked');
        const maxAllowedCheckboxes = 3;
        
        if (selectedCheckboxes.length > maxAllowedCheckboxes) {
            // Uncheck the last checked checkbox if the limit is exceeded
            event.preventDefault();
            
            // Show an alert dialog box
            alert('You can only select up to 3 evaluators.');
        }
    }
